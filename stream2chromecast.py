...
Play an unsupported media type (e.g. an mpg file) using ffmpeg or avconv as a realtime transcoder
...
def play(filename, transcode=False, transcoder=None, transcode_options=None, transcode_input_options=None,
    ...
    # create a webserver to handle a single request for the media file on either a
    # free port or on a specific port if passed in the port parameter
    port = 0
